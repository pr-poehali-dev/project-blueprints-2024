...
const steps = [
  {
    icon: "MessageCircle",
    title: "Бриф и бесплатный аудит",
    description:
      "Знакомимся с вашим брендом и бизнесом. Проводим бесплатный аудит соцсетей и конкурентов. Определяем цели, позиционирование и стратегию роста.",
    number: "01",
  },
  {
    icon: "Lightbulb",
    title: "Стратегия и производство",
    description:
      "Разрабатываем контент-стратегию, пишем сценарии, снимаем и монтируем Reels. Команда — продюсер, SMM и мобилограф — работает в синхроне. Ничего без вашего одобрения.",
    number: "02",
  },
  {
    icon: "TrendingUp",
    title: "Публикация, рост и актуализация",
    description:
      "Публикуем контент по расписанию, управляем аудиторией, запускаем рекламу. Ежемесячно анализируем метрики и актуализируем стратегию под новые тренды.",
    number: "03",
  },
]
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            От <span className="text-primary">брифа</span> до <span className="text-primary">результата</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            В три чётких шага превращаем ваш бренд в медиа, которое привлекает клиентов каждый день.
          </p>
        </div>
