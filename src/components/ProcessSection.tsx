...
const steps = [
  {
    ...
    title: "Бриф и аудит",
    description:
      "Знакомимся с вашим брендом, разбираем текущие соцсети, анализируем конкурентов. Определяем цели, аудиторию и ключевые сообщения для контента.",
    number: "01",
  },
  {
    icon: "Lightbulb",
    ...
    description:
      "Создаём контент-план, пишем сценарии, снимаем и монтируем Reels. Каждый ролик проходит согласование — ничего не выходит без вашего одобрения.",
    number: "02",
  },
  {
    icon: "Rocket",
    ...
    description:
      "Публикуем контент по расписанию, управляем комментариями, запускаем рекламу. Еженедельно анализируем метрики и корректируем стратегию для роста.",
    number: "03",
  },
]
