    ...
    <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="container mx-auto text-center max-w-5xl relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 animate-fade-in-up">
          ...
          <span className="text-sm font-medium text-primary">Креативное SMM & Reels агентство</span>
        </div>
        ...
        <p className="text-xl sm:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto animate-fade-in-up animate-delay-100 leading-relaxed">
          Мы создаём Reels и SMM-стратегии, которые приводят подписчиков, повышают охваты и превращают аудиторию в покупателей.
        </p>
